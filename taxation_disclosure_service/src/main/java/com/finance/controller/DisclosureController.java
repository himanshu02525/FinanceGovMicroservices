...
public class DisclosureController {
    ...
    @PostMapping("/enter_disclosure")//citizen
    ...
    @GetMapping("/all_disclosures")//financial officer, admin
    ...
    @GetMapping("/{disclosureId}")//citizen, financial officer
    ...
    @GetMapping("/entity/{entityId}")//citizen, financial officer
    ...
    @PatchMapping("/{disclosureId}/validate")//financial officer
