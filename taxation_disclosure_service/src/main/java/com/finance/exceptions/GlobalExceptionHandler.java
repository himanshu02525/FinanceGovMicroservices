...
public class GlobalExceptionHandler {
    ...
    // 4. Handle Invalid Tax Year (e.g., filing for years outside current/previous range)
...
//    public ResponseEntity<Object> handleNotificationDispatchException(NotificationDispatchException ex, WebRequest request) {
//    	Map<String, Object> body = new LinkedHashMap<>();
//    	body.put("timestamp", LocalDateTime.now());
